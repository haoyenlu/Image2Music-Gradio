# Tiktok-Techjam Challenge - Image2Music  :notes:
...
The website is hosted using Vest.Ai GPU server. Try out the demo with this url: [Image2Music](https://image2music.ptolemyth.com/)
